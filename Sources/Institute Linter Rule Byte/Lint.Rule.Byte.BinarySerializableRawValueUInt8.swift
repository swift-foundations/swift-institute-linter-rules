        ...
        for member in members.members {
            ...
            for binding in variable.bindings {
                ...
                if byteTypeAnnotationIsUInt8(typeAnnotation.type) {
                    typesWithRawValueUInt8.append((typeName, pattern.identifier.positionAfterSkippingLeadingTrivia))
                }
            }
        }
    }
...
internal func inheritanceContainsSerializableLikeProtocol(_ clause: InheritanceClauseSyntax) -> Swift.Bool {
