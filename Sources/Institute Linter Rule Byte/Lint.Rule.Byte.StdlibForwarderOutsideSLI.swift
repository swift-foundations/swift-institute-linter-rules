...
private func byteStdlibForwarderHasDisfavoredOverload(_ attributes: AttributeListSyntax)
  -> Swift.Bool
{
...
private func byteStdlibForwarderInitializerMentionsUInt8(_ node: InitializerDeclSyntax)
  -> Swift.Bool
{
  for parameter in node.signature.parameterClause.parameters {
    if byteStdlibForwarderTypeMentionsUInt8(parameter.type) {
...
private func byteStdlibForwarderWhereClauseMentionsUInt8(_ whereClause: GenericWhereClauseSyntax)
  -> Swift.Bool
{
...
private func byteStdlibForwarderExtensionConstraintMentionsUInt8(_ ext: ExtensionDeclSyntax)
  -> Swift.Bool
{
